...
function escolherImagem(inputId, imageContainerId) {
...
escolherImagem('primeira-imagem', 'imagem1');
escolherImagem('segunda-imagem', 'imagem2');
escolherImagem('terceira-imagem', 'imagem3');
escolherImagem('quarta-imagem', 'imagem4');
escolherImagem('quinta-imagem', 'imagem5');
escolherImagem('sexta-imagem', 'imagem6');
